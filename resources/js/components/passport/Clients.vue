...
<script>
    export default {
        ...
        methods: {
             ...
             */
            getClients() {
                axios.get('/apirest-viajes/public/oauth/clients')
                        .then(response => {
            ...
            store() {
                this.persistClient(
                    'post', '/apirest-viajes/public/oauth/clients',
            ...
            update() {
                this.persistClient(
                    'put', '/apirest-viajes/public/oauth/clients/' + this.editForm.id,
             ...
             */
            destroy(client) {
                axios.delete('/apirest-viajes/public/oauth/clients/' + client.id)
                        .then(response => {
                            this.getClients();
                        });
            }
